view: otsForeignKey {
  ...
  dimension: pk_table_name {
    ...
    link: {
      label: "Table columns"
      url: "/explore/OTM/Staging?fields=otsTableColumn.table_name,otsTableColumn.column_name&f[otsRun.run_id]={{ run_id._value }}&f[otsTableColumn.catalog_name]={{ pk_catalog_name._value }}&f[otsTableColumn.schema_name]={{ pk_schema_name._value }}&f[otsTableColumn.table_name]={{ value }}"
    }
    }
